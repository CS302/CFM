<%@ Page Title="Выполнить вход" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Senya.Account.Login" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <section id="loginForm">
        <h2>Используйте для входа свою учетную запись.</h2>
        <asp:Login runat="server" ID="_login" ViewStateMode="Enabled" RenderOuterTable="false">
            <LayoutTemplate>
                ...
                <fieldset>
                    ...
                    <ol>
                        <li>
                            ...
                            <asp:TextBox runat="server" ID="UserName" ClientIDMode="Inherit" />
                    ...
                    <asp:Button ID="_btn_Login" runat="server" Text="Выполнить вход" OnClick="_btn_Login_Click"/>
                </fieldset>
            </LayoutTemplate>
        </asp:Login>
        <p>
